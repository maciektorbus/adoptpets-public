			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="card mb-4" style="width: 18rem;">
						<img class="card-img-top" src="{{ $pet->photo ? asset('storage/' . $pet->photo) :  'https://loremflickr.com/320/240'}}" alt="Card image cap">
						<div class="card-body">
							<h5 class="card-title">{{ $pet['name'] }}</h5>
							<p class="card-text">{{ $pet['short_description'] }}</p>
							<a href="{{ route('petdetails', $pet) }}" class="btn btn-primary">Details</a>
						</div>
					</div>
				</div>
				@endforeach
