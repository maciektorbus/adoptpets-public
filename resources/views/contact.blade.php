...
<head>
	...
	<script type='text/javascript' src="https://www.bing.com/api/maps/mapcontrol?callback=GetMap&key={{ config('services.bing.key');  }}" async defer></script>
...
<body>
	...
	<main>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<div id="googlemap" style="position:relative;width:100%;height:350;"></div>
				</div>
				<br />
				<div class="col-md-6">
					<form class="my-form">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="form-name" placeholder="John">
						</div>
						<div class="form-group">
							<label for="form-email">Email Address</label>
							<input type="email" class="form-control" id="form-email" placeholder="example@email.com">
						</div>
						<div class="form-group">
							<label for="form-subject">Telephone</label>
							<input type="text" class="form-control" id="form-subject" placeholder="111-222-333">
						</div>
						<div class="form-group">
